...
**Hard gates:**
1. `python3 .claude/skills/business-review-v1/scripts/classify_diff.py "$REVIEW_DIR/pr-diff.patch" > "$REVIEW_DIR/diff-classification.json"` runs before planning.
2. `python3 .claude/skills/business-review-v1/scripts/validate_plan.py "$REVIEW_DIR/plan.md" || exit 1` runs before execution.
...
```bash
python3 .claude/skills/business-review-v1/scripts/aggregate_verdicts.py "$REVIEW_DIR"
```
